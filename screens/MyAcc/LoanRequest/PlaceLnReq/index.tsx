          ...
          const gtLnerDtls = async () => {
            ...
            try {
              ...
              const CreateNewSMAc2 = async () => {
                ...
                const loanReqMessage1 = 'NiSenti. Hi ' + namez + '. It is ' + name + '. I request a soft loan of ' + formatAmountSync(amountKes, currencyKey, ratesMap) + ' from you. ' + 'Please go to NiSenti app to grant me the request' + '. Thank you.';
                try {
                  ...
                  if (msgRes?.data?.createMessages) {
                    await client.graphql({
                      ...
                      variables: { riderEmail: phonecontactz, title: 'NiSenti: Loan Request', body: loanReqMessage1 }
                    });
                  }
                } catch (notifErr) {
                  ...
                  const CreateNewSMAc = async () => {
                    ...
                    try {
                      ...
                      if (msgRes?.data?.createMessages) {
                        await client.graphql({
                          query: sendNotification,
                          variables: { riderEmail: phonecontact, title: 'NiSenti: Witness Loan Contract', body: loanReqMessage2 }
                        });
                      }
                    } catch (notifErr) {
                      console.log('Notification error:', notifErr);
  ...
  return <View style={styles.image}>
                <ScrollView>
                  ...
                  <View style={styles.loanTitleView}>
                    ...
                    <TextInput placeholder='Loaner Email' value={awsEmail} onChangeText={setAWSEmail} style={styles.sendLoanInput} editable={true}></TextInput>
                    ...
                    <TextInput keyboardType='decimal-pad' placeholder="Loan Amount" value={itemPrys} onChangeText={setitemPrys} style={styles.sendLoanInput} editable={true}></TextInput>
                  
                  
                    <TextInput keyboardType='decimal-pad' placeholder='Annual Interest rate; Example: 8% write 8' value={lnPrsntg} onChangeText={setlnPrsntg} style={styles.sendLoanInput} editable={true}></TextInput>
                   
                    <TextInput keyboardType='decimal-pad' placeholder='Repayment Period in Days' value={rpymntPrd} onChangeText={setrpymntPrd} style={styles.sendLoanInput} editable={true}></TextInput>
                    ...
                    <TextInput placeholder='Loan Description (Optional)' value={ChmRegNo} multiline={true} onChangeText={setChmRegNo} style={styles.sendLoanInput2} editable={true}></TextInput>
                   
                    <TextInput value={pword} onChangeText={setPW} placeholder='Main Account Password' secureTextEntry={true} style={styles.sendLoanInput} editable={true}></TextInput>
