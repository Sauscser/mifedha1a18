                              ...
                              const fetchRecUsrDtls = async () => {
                                ...
                                try {
                                    ...
                                    try {
                                      ...
                                      if (msgRes?.data?.createMessages) {
                                        await client.graphql({
                                          ...
                                          variables: { riderEmail: phonecontact, title: 'NiSenti: Loan Disbursed', body: loanMessage3 }
                                        });
                                      }
                                    } catch (notifErr) {
                                      ...
                                      const updtRecAc3 = async () => {
                                        ...
                                        try {
                                          ...
                                          if (msgRes?.data?.createMessages) {
                                            await client.graphql({
                                              query: sendNotification,
                                              variables: { riderEmail: phonecontact, title: 'NiSenti: Loan Disbursed', body: loanMessage4 }
                                            });
                                          }
                                        } catch (notifErr) {
                                          console.log('Notification error:', notifErr);
                                  ...
                                  if (parseFloat(usrNoBL) > parseFloat(maxBLss)) {
                                    ...
                                    Alert.alert('Loanee ID be verified through deposit at NiSenti Ndogo');
