              ...
              <View style={styles.image}>
                <ScrollView>
                  ...
                  <View style={styles.sendLoanView}>
                    <TextInput placeholder={t.businessPhonePlaceholder} value={awsEmail} onChangeText={setAWSEmail} style={styles.sendLoanInput} editable={true}></TextInput>
                    <Text style={styles.sendLoanText}>{t.loanerBusinessPhone}</Text>
                  </View>
                  ...
                  <View style={styles.sendLoanView}>
                    <TextInput placeholder={t.installmentFrequencyPlaceholder} keyboardType='decimal-pad' value={InstFreq} onChangeText={setInstFreq} style={styles.sendLoanInput} editable={true}></TextInput>
                  ...
                  <View style={styles.sendLoanView}>
                    ...
                    <Text style={styles.sendLoanText}>{t.userMainAccountPassword}</Text>
                  </View>
