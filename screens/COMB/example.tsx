    ...
    <View style={styles.card}>
      ...
      {loadingAlert ? (
        ...
        <>
          ...
          >
            NiSenti Market Deviation: {alert.categoryDeviation.toFixed(2)}% | Policy Frequency: {parent.marketConsumptionFrequency}%
          </Text>
...
marketItemID: { eq: item.id }
  ...
  /* -------- NiSenti Market Deviation (all sellers) -------- */
...
input: {
            ...
            messageBody: `A NiSenti COMB voucher has been generated by ${parent.sellerName}. Please go to COMB to approve or decline as per your funders specifications.`,
          },
        }}
      );
...
input: {
            ...
            body: `A NiSenti COMB voucher has been generated by ${parent.sellerName}. Please go to COMB to approve or decline as per your funders specifications.`,
          }}}
        );
      }
