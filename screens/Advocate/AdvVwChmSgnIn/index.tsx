...
const MFNSignIn = props => {
  ...
  const VwMFNAc = () => {
    safeNavigateFrom(navigation, 'VwAdvChamaCovLnss', {
      AdvChmMmbr
    });
  };
  ...
  return <View>
      <View style={styles.image}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.sendLoanView}>
            <TextInput placeholder="+2547xxxxxxxx" value={MembrPhn} onChangeText={setMembrPhn} style={styles.sendLoanInput} editable={true} />
            <Text style={styles.sendLoanText}>Chama Member Phone</Text>
          </View>
