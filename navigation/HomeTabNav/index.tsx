...
import SellerPartialPayRecords from "../../screens/CredSls/SellerPartialPayRecords";
...
import CascadePaymentsScreen from "../../screens/CredSls/CascadePayments";
import CascadePayShopping from "../../screens/Ads/Search/CascadePayShopping";
...
export const HomeStackScreenNames = Array.from(new Set([
  ...
  'MembersApproveLoans','FunderClearBill','Vw2SignLoanRequests','ClearGroupMemberLoan',
  'VwFloatedLoans','FloatLnReq','Vw2FloatGrpLoans','Vw2LinkSeller','Vw2GenerateVoucher',
  'consumerApproveVoucher','BuyFloatBnkAdm','VwSalesDtls4Transport','ViewMessages',
  'GenerateCOMBVoucher','LinkCOMBSeller','AddCOMBPersonel','RideTrackingScreen',
  'PassengerRequestRide','AcceptRideRequest','COMB','DispatchDelivery',
  'ReceiveDelivery2','VwBiz2DispatchDelivery','VwTransportAccount',
  'ChangeDeliveryLocation','ShareTransportRevenue','ViewTransportPaymentRec',
  'ViewDeliveryPayments','RequestTransport','VwTransprtReqDtls','SrchLoanAdz',
  'RegisterTransport','RegisterTransportBizna','ViewTransportBiznaAccount',
  'MakeTransportBizDpsts','TransportDetails','AcceptTransportRequest',
  'ViewChama2CommitTransport','VwBeneficiaryContriDtls','WithdrawFundsFromMap',
  'ViewGrp2ConfirmDividends','ViewGrp2ShareDividends','SendMmbrsMny','VwChamaMembers',
  'PayCash3','VwBizDpstsMFN','ViewBiznaShareSent2Pal','VwBiz2AddItem',
  'VwBenCreatorContriDtls','RegBankAdmin','ViewAsProdCreator','CascadePaymentsScreen',
  'GroupControlTable','PaystackTNC','ViewMFBankAdmin','ViewSyncedGrpBenefits',
  'ViewSyncedGrpLoansOut','ViewSyncedGrpWithdrawals','ViewSyncedGrpdividends',
  'SyncGrpWithdrawals','SyncGrpDeposits','SyncGrpBenefits','UpdateBankAdminAc',
  'MFBankAdmin','ViewGrpApplications','RegGrp','SignBankInAdm','SyncGrpdividends',
  'SyncGrpLnRpyment','SyncGrpLoansOut','SyncGrpSubscription','WithdrawBankAdmin',
  'UpdatePayStack','UrlLinks','VwPalBenefactorContriDtls','ViewPalBenefactorShares',
  'ShareCredSlsRev2Biz','PaystackPayment','HowTo','DepositOptions','Mpesa','HowTo2',
  'ViewBiznaShareRecBiz','VwPalBeneficiaryShares','BoostPalBenefits','ViewBenShares',
  'BoostPooledBen','VwAsBenefactors','VwAsBeneficiary','VwBenefactorContriDtls',
  'VwBizBeneficiaryShares','ViewBizBenefactorShares','SharePalBenefits',
  'AddPalPalBeneficiary','AddPalBizBeneficiary','Benefits','ShareBizBenefits',
  'ChmMmbrContriss','VwBenToShare','B2BPayCashB2BBen','ViewBenProds','VwBenProds',
  'MemberDtls','LinkBizBeneficiary','LinkPalBeneficiary','VwBenProdsDtls',
  'AddBeneficiaryProduct','CreateExRates','CreateAllExRates','MemberReqChm',
  'VwToRegMFK','Vw2SelectChm2Req','VwCompMFAdvTC','WithdrwFundsOptions',
  'WithdrawalOptions','VwCompMFKTC','VwCompMFNTC','MakeNVwPayPalDpsits',
  'BizReadPayPalTNC','BizPayPalDposit','UpdateMainAc','AddBeneficiary','ChmAddAdmin',
  'UpdateBizAc','UpdateChmAc','BizAddAdmin','AddBizBeneficiary','BizCancelObjection',
  'BizObject','BizUpdatePW','ChmCancelObjection','ChmObject','ChmUpdate',
  'ViewBiznaShareRecP2B','ViewBiznaShareSentP2B','ViewBiznaShareRecB2B',
  'ViewBiznaShareSentB2B','ViewBiznaShareRecB2P','ViewBiznaShareSentB2P',
  'VwMbrSubsDirectly','ChamaDtls','PenaliseMember','B2BPayCashReq','B2BPayCashVw2Grant',
  'B2BPayCash','B2PPayCashReq','B2PPayCash','P2BPayCash','B2PPayCashVw2Grant',
  'Vw2SelectChmBeneficiary','SendNLBnftChm','BenefitChmSenderOnly','SendNLBnftNone',
  'ChmLnsRec','ChmLnsSent','ChmLoaneesDtls','ChmLoanersDtls','WaiveBiz2Biz',
  'WaiveBiz2Pal','WaivePal2Biz','WaivePal2Pal','WaiveSMBiz2Pal','WaiveSMPal2Pal',
  'WaiveChmCov','MakeBizDpsts','VwBizDpsts','Vw2ApproveChmReq','Vw2ApproveBizReq',
  'SgnIn2TransferBiz','Vw2ApprovePPReq','ReadPayPalTNC','CredB2PSent','CredB2PReceived',
  'CredP2BReceived','CredP2BSent','CredRPyBiz2Biz','CredRPyBiz2Pal','CredRPyPal2Biz',
  'CredRPyPal2Pal','SI2VwBiz2PalLoaners','SI2VwBiz2PalLoanees','VwBiz2PalLnees',
  'VwBiz2PalLners','VwPal2BizLnees','VwPal2BizLners','VwMyBiz2PalLoaneesDtld',
  'VwMyBiz2PalLoanersDtld','VwMyPal2BizLoaneesDtld','VwMyPal2BizLoanersDtld',
  'BLCredBiz2Biz','BLCredBiz2Pal','BLCredPal2Biz','BLCredPal2Pal','CredB2BSent',
  'CredB2BReceived','CredP2PReceived','CredP2PSent','SI2VwBiz2BizLoanees',
  'SI2VwBiz2BizLoaners','VwBizLnees','VwBizLners','VwPalLnees','VwPalLners',
  'VwMyBizLoaneesDtld','VwMyBizLoanersDtld','VwMyPalLoaneesDtld','VwMyPalLoanersDtld',
  'VwB2PMyLoanersDtld','VwB2PMyLoaneesDtld','VwP2PMyLoaneesDtld','VwP2PMyLoanersDtld',
  'SignIn2VwLR','VwB2PLRSent','VwB2PReceived','VwP2PReceived','VwP2PSent','PlaceLnReqP2P',
  'PlaceLnReqB2P','PalProdsRequest','SI2VwB2PLoanees','VwB2PMyLoaners','VwB2PMyLoanees',
  'VwP2PMyLoanees','VwP2PMyLoaners','SISgnInToBLB2P','Vw2BLBiz2Pal','Vw2BLPal2Pal',
  'BLBiz2Pal','BLPal2Pal','SIBiz2Pal2Repay','RpyBiz2Pal','RpyPal2Pal','Vw2RpyB2P',
  'Vw2RpyP2P','PersonelVw2GrntB2B','PersonelVw2GrntB2P','Vw2GrntBiz2Biz','Vw2GrntBiz2Pal',
  'Vw2GrntPal2Biz','Vw2GrntPal2Pal','BizPalLn','PalPalLn','SignIn2GrntLnReq',
  'CompVw2GrantLnReq2','PalVw2GrantLnReq2','GrantBiz2BizCrdSl','GrantBiz2PalCrdSl',
  'GrantPal2BizCrdSl','GrantPal2PalCrdSl','PlaceLnReq2','PlaceLnReq3','PlaceLnReq',
  'PlaceLnReq4','SIBiz2Biz','SIBiz2Pal','VwBiz2Biz','VwBiz2Pal','VwPal2Biz',
  'BiznaReqstPage1','BiznaReqstPage2','TakeOverBizna','giveBizna','VwBusAc2TakeUp',
  'SgnIn2VwCashSales','VwAcBfDpst','PayPalDposit','PayCash','VwCashPayRec',
  'VwCashPaySent','VwGrp2LnNonCov','VwGrp2LnCov','DeclChamaReq','DeclCredSls',
  'DeclPalLn','VwMFNAcDtls','ApplyMFKubwa','ViewAlertDtls','SgnIn2VwRevenueShare',
  'ViewBiznaShareSent','ViewBiznaShareRec','RequestLoansPage','ChamaPlaceLnReq',
  'ChamaVw2DelLnReqs','ChamaVw2GrantLnReqCov','ChamaVw2GrantLnReqNonCov',
  'CrdSlVw2DelLnReqs','CrdSlVw2GrantLnReqNonCov','Vw2GrantLnReq2','EntrAdvLoc',
  'Vw2DelLnReqs','Vw2DelLnReqsBiz','AutomaticRepayAllTyps','VwMakeLnReq','VwPlLn2Remove',
  'PartialPayFlow','SgnIn2RemoveSlAd','VwSlsAds2Remove','DetailedChmPrfl',
  'DtldPalLnInfo','DtldSalesInfo','LoanAd','ItemAd','LoanChms','SrchItemAds',
  'SrchLoanAds','LnsScreen','CredSlsScreen','ChamaScreen','SgnIn2VwChmDpsts',
  'VwChmDpsts','VwChmWthdrwls','SgnIn2VwChmWthdrwls','SignInAdms','SnIn2VwCrdSlLPs',
  'SgnIn2VwCovCrdSlsLneesss','SgnIn2VwNCCrdSlsLneess','VwBusAcss','DissolveBizss',
  'RmvPersonnelss','SgnIn2VwBiznass','ShareCredSlsRevss','AddPersonels','CrtBusinesss',
  'Vw2CredSellCovs','Vw2CredSellNonCovs','SignitoryWthdrwFndsss','SignitoryDepositss',
  'Sgn2CnfrmWthdrwlsss','AddMFKubwas','AddMFNdogos','ViewNonLnsSents','ViewNonLnsRecs',
  'SendNonLonsRev','SendNonLonsRevSgnIn','SendNonLonsRevVw','ElimChmVwMbrshpMembrs',
  'ElimChmVwNonCvLns','ElimChmVwRmtncMembrs','ElimChmVwCovLnss','ElimChmVwCntrMembrs',
  'ElimCredCvLnees','ElimCredCvLnrs','ElimCredNonCvLnees','ElimCredNonCvLnrs',
  'ElimLPChmSents','ElimRpyChmNonCvs','ElimRpyChmCvs','ElimRpySMNonCovs','ElimRpySMCovs',
  'ElimRpyCredCovs','ElimRpyCredNonCovs','ElimLnsCvLnrs','ElimLnsCvLnees',
  'ElimLnsNonCvLnrs','ElimLnsNonCvLnees','ElimLPSMSents','ElimLPSMRecs','ElimLPCredRecs',
  'ElimLPCredSents','ElimNonLnsSents','ElimNonLnsRecs','ElimWthdrwlss','ElimDpstss',
  'ElimAcs','RegPwnBrkrs','BuyFloatFrmUsrAcs','SgnIn2BLCredSlCovs',
  'SgnIn2BLCredSlNonCovs','SgnIn2BLSMCovs','SgnIn2BLSMNonCovs','PwnBrkrRegss',
  'ChamaRegss','Vw2BLChmCovs','Vw2BLChmNonCovs','ChmVwMmbrss','ChmVwMmbr2Removes',
  'SgnIn2RemoveMmbrs','ChamaSignIn2VwLnRpymnts','ViewNonLnsRecChm',
  'ViewNonLnsRecCredSlrs','ViewNonLnsRecSMs','ViewNonLnsSntChm','ViewNonLnsSntCredSlrs',
  'ViewNonLnsSntSMs','AdvPy2VwChms','AdvPy2VwCredSlrs','AdvPy2VwSMs','AdjustUsrLimitss',
  'UpdtVatComss','UpdateMFKComs','UpdateMFNComs','VwCompAbts','VwCompPolicys',
  'VwCompPrivacys','VwCompTCs','ViewAdvs','DeactAdms','Vw2RepyCredSlsCovLns',
  'Vw2RepyCredSlsNonCovLns','Vw2BLCovCredSlsLns','Vw2BLCredSlsNonCovs',
  'Vw2RepySMCovLns','Vw2RepySMNonCovLns','Vw2BLCovSMLns','Vw2BLSMNonCovs',
  'SgnIn2BLCovs','SgnIn2BLNonCovs','Vw2BLCovs','Vw2BLNonCovs','Vw2RpyNonCovs',
  'Vw2RpyCovs','VwChmMbrs2NonCovLnss','SgnIn2LnMmbrNonCovs','SgnIn2LnMmbrs',
  'VwChmMbrs2Ln','MmbrSndChmss','SndToChmMbrss','ChamaSndMbrMneys','SndChmMbrMnys',
  'Commissionss','VwCompDtlss','Aboutss','Alertss','Contactsss','Maximumss',
  'Passwordsss','Policyss','Privacys','Recommendationsss','TCss','TransactionFeess',
  'WelcomePgss','UpdateAccCodess','MFKVwMFNSgnInss','MFKVwMFNss','AdvVwCrdSlsSgnIns',
  'AdvVwSMSgnIns','AdvWthdrwlSgnIns','AdvVwAcSgnIns','AdvVwChmSgnIns','VwAdvAcs',
  'VwAdvChamaCovLnss','VwAdvCrdSlrCovLnss','VwAdvSMCovLnss','VwAdvWthdrwlss',
  'VwMFKAcSgnIns','VwMFKWthdrwlsSgnIns','VwMFKAcs','VwMFKWthdrwlss','SearchMFNsssss',
  'VwMFNFltBuyss','VwMFNWthdrlss','VwFltWthdrwlss','VwUsrWthdrwlss','VwUsrDpstss',
  'VwMFNAcss','VwMFNAccountSgnIns','FltWthdrwlsSgnIns','UsrWthdrwlsSgnIns',
  'MFNWithdrawlsSgnIns','UsrDpositSgnIns','FloatBghtSgnIns','SMDpsitss','SMWthdrwlss',
  'CredSlsLneess','CredSlsLnerss','CredByrLneess','CredByrLnerss','ChamaMmbrRemts',
  'ChmMmbrContris','ChmMmbrMmbrss','ChamaRemts','ChmContris','ChmMmbrss','ChmSignIn5s',
  'ChmSignIn6s','ChamaGenInfos','ChamSignIn2s','ChamSignIn3s','ChamSignIn4s',
  'ChmSignInss','ChmLnsGvnOuts','ChmLnsGvnOutNonCovs','VwNonLnsSnts','VwNonLnsRecs',
  'ViewSmAcss','ViewSmAcs','ViewMyNonCovLoaneess','ViewMyNonCovLoanerss',
  'ViewMyCovLoanerss','ViewMyCovLoaneess','WthdrwMFNFlts','AdvHms','WthdrwMFNs',
  'UpdtMFNPWs','MFKWthdrws','UpdtMFKPWs','BLUsrss','UpdtMFAdvPWs','WithdwAdvs',
  'WithdwAdmns','MFNdogoo','MyHomeie','RegMFKbw','CreateSMAc','RegMFNdgScrn',
  'BuyFltFm','DpstMney','CrtAdmin','SttinsHm','MFAdminstrator','MFKbwa',
  'MFNdogoss','MFAdvocateHome','MFAdvocateReg','DActvteMFN','DActvteMFK','DActvteMFUsr',
  'DActvteMFAd','SMGivCovLon','SMGivNonCovLon','SMWthdFm','SendNonLnss','RepayCovLnss',
  'RepayNonCovLnss','CovCredSls','NonCovCredSlss','CredSlsHms','CreateChms',
  'AddChmMembrsss','ChmCovLons','ChmNonCovLons','Contributionssss','SndMbrsMnys',
  'BLChmMmberCovs','BLChmMmberNonCovs','RepyChmCovLns','RepyChmNonCovLns',
  'BListCredByrCovs','BListCredByrNonCovs','RpayCredSlrCovs','RpayCredSlrNonCovs',
  'BListSMLneeCovs','BListSMLneeNonCovs','RemoveChmMbrs','DissolveChms','UpdateChms',
  'UpdateSMPWs','UpdateMFAdminPWs','UpdateExRates', "AcceptRideRequest", "PassengerRequestRide", "RideTrackingScreen", "COMB", "AddCOMBPersonel",
  "ViewMessages", "GenerateCOMBVoucher", "LinkCOMBSeller", "CreateCOMBContract", "Vw2LinkSeller",
  "Vw2GenerateVoucher", "consumerApproveVoucher", "FunderClearBill", "Vw2SignLoanRequests",
  "ClearGroupMemberLoan", "RecoverMemberLoan", "VwFloatedLoans", "FloatLnReq", "Vw2FloatGrpLoans",
...
const HomeNavigator = ({ navigation, route }: any) => {
  const pendingScreen = route?.params?.screen;
  const pendingParams = route?.params?.params;
  const handledPending = React.useRef<string | null>(null);
...
<Stack.Screen name={'ViewAsProdCreator'} component={ViewAsProdCreator} />
      <Stack.Screen name={'CascadePaymentsScreen'} component={CascadePaymentsScreen} />
            <Stack.Screen name={'CascadePayShopping'} component={CascadePayShopping} />
     ...
     <Stack.Screen name={'RegGrp'} component={RegGrp} />
      ...
      <Stack.Screen name={'ShareCredSlsRev2Grp'} component={ShareCredSlsRev2Grp} />
      ...
      <Stack.Screen name={'SellerPartialPayRecords'} component={SellerPartialPayRecords} />
