...
def main():
    ...
    screens_ads = data.setdefault("screens", {}).setdefault("Ads", {})

    updated = merge_tree(screens_ads, SCREENS_ADS)

    I18N.write_text(json.dumps(data, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print(f"UPDATED_ADS_ENTRIES {updated}")
