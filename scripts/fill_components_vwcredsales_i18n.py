...
TARGET = ROOT / "components" / "VwCredSales"
...
def main():
    ...
    target_node = data.setdefault("components", {}).setdefault("VwCredSales", {})
    ...
    for file in sorted(TARGET.rglob("index.*")):
        ...
        node = ensure_node(target_node, parts)
    ...
    print(f"UPDATED_COMPONENT_VWCREDSALES_ENTRIES {updated}")
